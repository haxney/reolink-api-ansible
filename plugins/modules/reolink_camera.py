...
options:
  ...
  ftp_upload:
    ...
    type: bool
examples:
  - name: Set NTP server and enable sync
  ...
  - name: Configure video stream for channel 0
    haxney.reolink.reolink_camera:
      hostname: 192.168.1.100
      password: mypassword
      channel: 0
  ...
  - name: Enable IR lights and motion detection
    haxney.reolink.reolink_camera:
      hostname: 192.168.1.100
      password: mypassword
      ir_lights: true
  ...
  - name: Full NVR channel 2 configuration
    haxney.reolink.reolink_camera:
